...
def user_input(user_question):
    ...
    try:
        ...
        # Combine both responses using Gemini
        combine_prompt = f"""
        You are an AI assistant tasked with combining two responses into a single, comprehensive, and diverse answer.

        The first response is based on a document search:
        {document_response}

        The second response is a general answer generated by Gemini:
        {general_answer}

        Please combine these two responses into a single, coherent, and comprehensive answer. Ensure that the final answer is diverse, well-structured, and addresses the user's question effectively.
        """
